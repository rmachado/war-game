...
const SHAPE_SVGS: Record<string, string> = {
  triangulo: `<svg viewBox="0 0 24 24" width="36" height="36"><polygon points="12,2 22,20 2,20" fill="black"/></svg>`,
  cuadrado: `<svg viewBox="0 0 24 24" width="36" height="36"><rect x="3" y="3" width="18" height="18" rx="1" fill="black"/></svg>`,
  circulo: `<svg viewBox="0 0 24 24" width="36" height="36"><circle cx="12" cy="12" r="9" fill="black"/></svg>`,
};
...
export default function TerritoryCard({
  ...
  return (
    <button
      ...
      className={`relative w-28 lg:w-40 aspect-[2.5/4.0] rounded-xl border-2 transition-all overflow-hidden ${
        isSelected
    ...
    >
      {isJoker ? (
        ...
        <div className="absolute inset-0 flex flex-col items-center px-2 py-4">
          ...
          <span className="text-black text-sm lg:text-base font-semibold text-center leading-tight mt-1 drop-shadow-md px-1">
